...
class _GiphyTabDetailState extends State<GiphyTabDetail> {
  ...
  Widget _item(GiphyGif gif) {
    ...
    final String? placeholderUrl = gif.images?.fixedWidthStill?.url ?? gif.images?.previewWebp?.url ?? gif.images?.downsizedStill?.url;
                                  ...
                                  ? Stack(
                                      ...
                                      children: [
                                        ...
                                        Align(
                                          ...
                                          child: widget.loadingWidget ?? CircularProgressIndicator(strokeWidth: 2),
                                        ),
                                      ],
                                    )
